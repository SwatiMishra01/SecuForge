...
export const DeveloperSection: React.FC<DeveloperSectionProps> = ({ className = '' }) => {
  ...
  const socialLinks = [
    ...
    {
      href: 'https://www.linkedin.com/in/swati-mishra-8a5a18259/',
      icon: <Users className="h-4 w-4" />,
      label: 'LinkedIn',
      hoverColor: 'blue'
    },
    {
      href: 'https://portfolio-psi-pink-n4mcuxeu4t.vercel.app/',
      icon: <Star className="h-4 w-4" />,
      label: 'Portfolio',
      hoverColor: 'purple'
    },
    {
      href: 'mailto:swati01mishra01@gmail.com',
    ...
    <section className={`py-8 sm:py-12 md:py-16 lg:py-20 xl:py-24 ${className}`} aria-labelledby="developer-title">
      <div className="text-center mb-8 sm:mb-12 lg:mb-16 px-4 sm:px-0">
        ...
        <p className="text-responsive-base text-slate-600 dark:text-slate-400 max-w-3xl mx-auto">
          Built with passion by a spftware developer  enthusiast and full-stack developer
        </p>
      </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
              ...
              <div className="text-center lg:text-left">
                ...
                <div className="space-y-2">
                  <h4 className="text-xl font-bold text-slate-900 dark:text-white">Swati Mishra</h4>
                  <p className="text-slate-600 dark:text-slate-400 text-sm">Software developer Enthusiast | Full-Stack Developer</p>
                  <p className="text-slate-500 dark:text-slate-400 text-xs">B Tech, IGDTUW</p>
                </div>
              </div>
              ...
              <div className="lg:col-span-2 space-y-4">
                <p className="text-slate-700 dark:text-slate-300 leading-relaxed">
                  Hi, I'm Swati Mishra, a passionate software developer enthusiast and Full-Stack Developer.
                  I thrive at the intersection of technology and innovation, crafting secure and scalable solutions
                  for real-world challenges.
                </p>
                <p className="text-slate-700 dark:text-slate-300 leading-relaxed">
                  Currently pursuing a B TECH from IGDTUW, I specialize in C++, JavaScript,
